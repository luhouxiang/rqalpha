...
"""
cli_prefix = "mod__sys_minute__"

cli.commands['run'].params.append(
    click.Option(
        ('--signal', cli_prefix + "signal"),
        is_flag=True,
        help="[sys_minute] exclude match engine",
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        type=click.FLOAT,
        help="[sys_minute] set commission multiplier"
    )
)
...
cli.commands['run'].params.append(
    ...
    click.Option(
        ...
        help="[Deprecated][sys_minute] set matching type"
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        type=click.Choice(['current_bar', 'next_bar', 'last', 'best_own', 'best_counterparty']),
        help="[sys_minute] set matching type"
    )
)
